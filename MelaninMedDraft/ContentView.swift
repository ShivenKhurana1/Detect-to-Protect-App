...
struct NotifView: View {
                ...
                if showEnableButton && !showPopup {
                    Button(action: {
                        ...
                        VStack {
                            ...
                            Text("We'll remind you to visit your doctor for high-risk abnormalities, as well as to re-scan concerning cancerous cells.")
                                .font(.subheadline)
                                .padding()
    ...
    public func scheduleNotification(interval: NotificationInterval) {
        ...
        content.title = "Scan your lung cancer concerns"
        content.body = "Check radiologist given CT Scans for cancer now."
        ...
        NavigationView {
            ZStack {
                TabView(selection: $currentPage) {
                    OnboardingPage(
                        descriptions: [
                            try! AttributedString(markdown: "Lung cancer is the **deadliest kind of cancer** in the US."),
                            try! AttributedString(markdown: "AI classifiers can help with early detection, boosting survival from 35% to 94%."),
                            try! AttributedString(markdown: "However, almost **all** appstores **don't have lung cancer scanning apps**, raising the need for more uses of AI")
                        ],
                    ...
                    OnboardingPage(
                        descriptions: [
                            try! AttributedString(markdown: "Enter **Detect to Protect**, the first AI Lung Cancer detection app designed for CT Scans."),
                            try! AttributedString(markdown: "Detect to Protect has **94% accuracy** in detecting three different types of cancerous cells and is currently training for more.")
                        ],
                        ...
                        if currentPage == index {
                            VStack {
                                ...
                                if index == 3 {
                                    ...
                                    Text("Welcome to Detect to Protect!")
                                        .font(.largeTitle)
                                        .fontWeight(.bold)
        ...
        NavigationStack {
            ScrollView {
                ...
                VStack(spacing: 12) { 
                    ...
                    RoundedRectangle(cornerRadius: 15)
                        ...
                        .overlay(
                            VStack {
                                Text("Income shouldn't dictate healthcare access.")
                                    .font(.title3)
                                    .padding(.vertical, 5)
                                    .multilineTextAlignment(.center)
                    ...
                    HStack(spacing: 15) {
                        RoundedRectangle(cornerRadius: 15)
                            ...
                            .overlay(
                                VStack {
                                    Text("An AI Lung cancer detector")
                                        .font(.subheadline)
                                        .foregroundColor(.black)
                                        .multilineTextAlignment(.center)
                                        .padding(.horizontal, 8)
                                        .padding(.top, 8)
                                    Text("designed for CT Scans.")
                                        .font(.subheadline)
                                        .fontWeight(.bold)
                                        .foregroundColor(.black)
                                        .multilineTextAlignment(.center)
          ...
          if !showMoreContent {
              ...
              VStack {
                  ...
                  Image("lung-cancer-chart") // Replace "yourImageName" with the actual name of your image in Assets.xcassets
                                  .resizable() // Allow the image to be resized
                                  .aspectRatio(contentMode: .fit) // Maintain aspect ratio while fitting within the available space
                  ...
                  Text("\n**Only 10%** of our competitor's models has above 90% accuracy. Their clinical trials **exclude** various types of CT Scans.\n\nDetect to Protect was trained on an intentionally diverse dataset, and has similar accuracy for every type of CT Scan.\n\n")
                      .font(.subheadline)
                      .padding(.horizontal, 20)
                      .multilineTextAlignment(.leading)
                  
                  Text("Detect To Protect **sees beyond the skin**.")
                      .font(.headline)
                      .padding(.horizontal, 20)
                      .multilineTextAlignment(.center)
                  ...
                  effect
                    ...
                    VStack {
                        ...
                        if malignantScans.isEmpty {
                            Text("All scans likely normal and of no concern.")
                                .font(.subheadline)
                                .foregroundColor(.black)
                                .padding(.top, 8)
                                .padding(.horizontal, 10)
                            ...
                            VStack {
                                Text("See a radiologist as soon as possible.")
                                    .font(.headline)
                                    .multilineTextAlignment(.center)
                                    .foregroundColor(.white)
                                    .padding(.top, 8)
