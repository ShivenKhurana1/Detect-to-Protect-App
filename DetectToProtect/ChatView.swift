            ...
            ScrollViewReader { proxy in
                ScrollView {
                    VStack {
                        ...
                        Text("Ask Detect To Protects's state-of-the-art radiologist chatbot anything.")
                            .font(.subheadline)
                            .foregroundColor(.black)
                            .padding(.horizontal)
                    ...
                    VStack(spacing: 0) {
                        ZStack {
                            ...
                            Text("What can I do to slow down the lung cancer growth process?")
                                .font(.subheadline)
                                .padding()
                        ...
                        ZStack {
                            ...
                            Text("What treatment options are there for lung cancer?")
                                .font(.subheadline)
                                .padding()
                                .cornerRadius(10)
                                .shadow(color: .gray.opacity(0.5), radius: 5, x: 0, y: 2)
                        ...
                        ZStack {
                            ...
                            Text("What do you recommend for Stage [Insert Stage Number] Lung Cancer patients?")
                                .font(.subheadline)
                                .padding()
                                .cornerRadius(10)
                                .shadow(color: .gray.opacity(0.5), radius: 5, x: 0, y: 2)
